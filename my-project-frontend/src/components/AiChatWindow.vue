        ...
        <div v-else class="chat-window">
            ...
            <div class="chat-window__messages">
                <div v-for="( message, index ) in messages" :key="index"
                    ...
                    <div class="message-text markdown-body" v-if="message.type === 'assistant'" v-html="renderMarkdown(message.text)"/>
                </div>
            </div>
            <div class="chat-window__input">
                <input class="send-input" @keydown.enter="sendMessage" v-model="inputText" type="text" placeholder="请输入要询问的内容..."/>
