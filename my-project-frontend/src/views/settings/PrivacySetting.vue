...
const rules = {
  ...
  new_password: [
    ...
    { min:6, max:20, message:'密码长度必须在6-16位之间', trigger:['blur'] }
  ],
  new_password_repeat: [
...
<template>
  <div style="margin: auto;max-width: 600px">
    <div style="margin-top: 20px">
      <card :icon="Setting"
            tittle="隐私设置" desc="在这里可以设置哪些内容能被其他人看到,请各位小伙伴注重自己的隐私" v-loading="saving">
      ...
      <card style="margin: 20px 0" :icon="Setting"
            tittle="修改密码" desc="修改密码请在这里进行操作,请务必牢记您的密码">
        <el-form :rules="rules" :model="form" ref="formRef" @validate="onValidate" label-width="100px" style="margin-right: 20px">
